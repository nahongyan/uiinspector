...
public:
    // Built-in (non-plugin) factory: provide id/name to match the server tool
    QString id() const override { return QStringLiteral("gammaray_widgetinspector"); }
    QString name() const override { return QStringLiteral("Widgets"); }
