...
{
    // ResourceBrowser removed in minimal client-only build; always fallback to external handling
    if (url.scheme() != QLatin1String("qrc")) {
        ...
        // qrc: links — open with default handler (no in-app resource browser)
